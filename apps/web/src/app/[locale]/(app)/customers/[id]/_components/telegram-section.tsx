        ...
        <div className="mt-3">
          ...
          <div className="mt-2 flex items-center gap-2">
            <input
              readOnly
              value={link.url}
              className="flex-1 rounded-md border border-slate-300 bg-slate-50 px-3 py-2 text-sm dark:bg-slate-800 dark:text-slate-300"
            />
            <button
              type="button"
              onClick={copy}
      ...
      <div className="mt-3 flex gap-2">
        {link.botUsername && (
          <button
            ...
            onClick={regenerate}
            disabled={pending}
            className="rounded-md border border-slate-300 px-3 py-1.5 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800 text-sm hover:bg-slate-50 disabled:opacity-60"
          >
